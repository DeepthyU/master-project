"""
This file is the main file for running the simulations on the Twitter dataset.
"""
import util
...
methods = ["degree", "pagerank", "cmia-o","biog","fair-cmia-o","myopic_maximin","protect","naive_protect"]
remaining_methods = []
