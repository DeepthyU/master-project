"""
This file is the main file for the astrophy dataset. It runs the experiments for the CA-AstroPh dataset.
"""
import util
...
if __name__ == '__main__':
    ...
    if True:
        pp_dict_dict, welfare_analysis_df = mu.run_simulations(folder, neg_policy, network_new_labels,
                                                               neg_seeds_new_labels, methods, remaining_methods, df_columns_added=False)
    else:
